...
exports.getEventReservations = getEventReservations;
 ...
 */
function reserveSpot(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const reservation = yield reservationService.reserve({ eventId: req.params.id, userId: req.userId });
...
function getMyReservations(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const reservations = yield reservationService.getByUser(req.userId);
 ...
 */
function getEventReservations(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const reservations = yield reservationService.getByEvent(req.params.id);
        res.json(reservations);
    });
}
