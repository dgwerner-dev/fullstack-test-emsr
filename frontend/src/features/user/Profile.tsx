    ...
    <div className="max-w-lg mx-auto mt-8 bg-white p-6 rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input name="name" value={form.name} onChange={handleChange} className="border px-2 py-1 rounded w-full" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Email</label>
          <input name="email" value={form.email} onChange={handleChange} className="border px-2 py-1 rounded w-full" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Nova senha</label>
          <input name="password" value={form.password} onChange={handleChange} type="password" className="border px-2 py-1 rounded w-full" />
        </div>
      ...
      <button onClick={handleDelete} className="mt-6 bg-red-500 text-white px-4 py-2 rounded w-full">Deletar minha conta</button>
    </div>
  );
} 