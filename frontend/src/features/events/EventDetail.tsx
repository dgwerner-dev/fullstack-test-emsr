        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Evento não encontrado</h3>
              <p className="text-gray-600 mb-4">O evento que você está procurando não existe ou foi removido.</p>
              <Link 
                href="/" 
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              {/* Capacity Info */}
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Capacidade</h3>
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Máximo de participantes:</span>
                      <span className="font-semibold text-gray-900">{event.maxCapacity}</span>
                    </div>
                    <div className="flex justify-between items-center">
            ...
            <div className="border-t border-gray-200 pt-8">
              <ReserveButton eventId={event.id} availableSpots={availableSpots} />
            </div>
          </div>
        </div>
      </div>
